...
const PARAM_JA: Partial<Record<ParamName, string>> = {
  ...
  chordLevel: "コード音量", chordCutoff: "コードカットオフ", chordAttack: "コードアタック", chordRelease: "コードリリース",
  riffLevel: "リフ音量", riffTone: "リフ音色", riffDecay: "リフ減衰",
  soloLevel: "ソロ音量", soloCutoff: "ソロカットオフ", soloGlide: "ソログライド", soloVib: "ソロビブラート",
...
const DESC_EN: Partial<Record<ParamName, string>> = {
  ...
  chordLevel: "chord pad level", chordCutoff: "chord filter cutoff", chordAttack: "chord fade-in", chordRelease: "chord fade-out",
  riffLevel: "riff level", riffTone: "riff filter cutoff", riffDecay: "riff note length",
  soloLevel: "solo level", soloCutoff: "solo filter cutoff", soloGlide: "solo portamento", soloVib: "solo vibrato depth",
...
const DESC_JP: Partial<Record<ParamName, string>> = {
  ...
  chordLevel: "コード音量", chordCutoff: "コードのフィルタ", chordAttack: "コードの立上り", chordRelease: "コードの余韻",
  riffLevel: "リフ音量", riffTone: "リフのフィルタ", riffDecay: "リフの音の長さ",
  soloLevel: "ソロ音量", soloCutoff: "ソロのフィルタ", soloGlide: "ソロのポルタメント", soloVib: "ソロのビブラート",

...
export const PARAMS = {
  ...
  chordAttack: n("VOICES", "chord attack", 0.005, 2, 0.4, 0.01, "s"),
  chordRelease: n("VOICES", "chord release", 0.05, 3, 0.6, 0.01, "s"),
  riffLevel: n("VOICES", "riff level", 0, 1, 0.5, 0.01),
  riffTone: n("VOICES", "riff tone", 300, 8000, 2200, 10, "Hz"),
  riffDecay: n("VOICES", "riff decay", 0.05, 1.5, 0.35, 0.01, "s"),
  soloLevel: n("VOICES", "solo level", 0, 1, 0.5, 0.01),
  soloCutoff: n("VOICES", "solo cutoff", 300, 9000, 2600, 10, "Hz"),
  soloGlide: n("VOICES", "solo glide", 0, 0.2, 0.03, 0.001, "s"),
  soloVib: n("VOICES", "solo vibrato", 0, 1, 0.3, 0.01),
